...
<directory_structure>
public/
  cv-sergio-algarrada-en.pdf
  cv-sergio-algarrada-es.pdf
  favicon.png
  sergio.png
src/
  app/
...
<file path="src/app/services/translation.spec.ts">
...
.hero-photo-wrapper {
  padding: 8px;
  border-radius: 50%;
  background: linear-gradient(135deg, rgba(56, 189, 248, 0.4), rgba(19, 29, 49, 0.8));
...
<head>
  <meta charset="utf-8">
  <title>Sergio Algarrada | Junior Full Stack & Multiplatform Developer</title>
  <base href="/">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  
  <!-- SEO General -->
  <meta name="description" content="Portfolio profesional de Sergio Algarrada Miranda. Desarrollador Junior Full Stack especializado en Java, Spring Boot, Angular y soluciones multiplataforma con Flutter.">
  <meta name="author" content="Sergio Algarrada Miranda">
  <meta name="keywords" content="Sergio Algarrada, Full Stack, Angular, Spring Boot, Java, Flutter, Firebase, DAM, Ayesa">

  <!-- Open Graph / LinkedIn / Facebook -->
  <meta property="og:type" content="website">
  <meta property="og:title" content="Sergio Algarrada | Junior Full Stack & Multiplatform Developer">
  <meta property="og:description" content="Especializado en Java, Spring Boot, Angular y Flutter. Con experiencia en entornos de producción en Ayesa y primer premio de desarrollo municipal.">
  <meta property="og:image" content="sergio.png">

  <!-- Twitter Card -->
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Sergio Algarrada | Junior Full Stack Developer">
  <meta name="twitter:description" content="Portfolio profesional: Proyectos en Angular, Spring Boot y Flutter.">
  <meta name="twitter:image" content="sergio.png">
    ...
    <div class="row align-items-center">
      <div class="col-lg-8">
        <span class="badge status-pill px-3 py-2 rounded-pill mb-3 fs-6 fw-normal">
          <i class="bi bi-circle-fill me-1" style="font-size: 0.6rem;"></i> {{ i18n.t().hero.status }}
        </span>

        <h1 class="display-4 fw-bold text-light mb-1">{{ i18n.t().hero.title }}</h1>
        <h2 class="fs-4 mb-4" style="color: #38bdf8;">{{ i18n.t().hero.role }}</h2>

        <p class="lead text-light opacity-75 mb-4" style="line-height: 1.7;" [innerHTML]="i18n.t().hero.desc"></p>

        <div class="d-flex gap-3">
          <a href="#projects" class="btn btn-tech px-4 py-2">
            {{ i18n.t().hero.btnProjects }} <i class="bi bi-arrow-right ms-1"></i>
          </a>
          <a href="#experience" class="btn btn-outline-light px-4 py-2">
            {{ i18n.t().hero.btnExperience }}
          </a>
        </div>
      </div>
    </div>
...
<file path="src/app/services/translation.ts">
  ...
  private readonly translations = {
    en: {
      ...
      hero: {
        ...
        desc: 'Focused on building robust web solutions with <strong>Java, Spring Boot, and Angular</strong>, alongside cross-platform projects using <strong>Flutter and Firebase</strong>. Experienced with production workflows at Ayesa and clean software development practices.',
      ...
      experience: {
        ...
        bullet4: 'Provided technical support and bug tracking in live production environments.',
      },
      projects: {
    ...
    es: {
      ...
      hero: {
        ...
        desc: 'Especializado en el desarrollo de soluciones web robustas con <strong>Java, Spring Boot y Angular</strong>, y aplicaciones multiplataforma con <strong>Flutter y Firebase</strong>. Con experiencia real en entornos de producción en Ayesa y buenas prácticas de desarrollo.',
      ...
      projects: {
        ...
        urbiTitle: 'UrbiConnect',
        urbiDesc:
          'Plataforma de gestión de incidencias municipales desarrollada para el Ayuntamiento de Cantillana. Facilita la comunicación directa entre la ciudadanía y los servicios operativos para el reporte, seguimiento y resolución de incidencias en la vía pública.',
        bullet1:
        ...
        bullet3:
          'Integración de mapas interactivos y geolocalización en tiempo real mediante <strong class="text-light">Google Maps API</strong>.',
        badgeAi: 'Desarrollo con IA',
      },
      skills: {
  ...
  private readonly translations = {
    ...
    es: {
      ...
      hero: {
        ...
        title: 'Sergio Algarrada Miranda',
        role: 'Desarrollador Junior Full Stack y Multiplataforma',
        desc: 'Especializado en el desarrollo de soluciones web robustas con <strong>Java, Spring Boot y Angular</strong>, y aplicaciones multiplataforma con <strong>Flutter y Firebase</strong>. Con experiencia práctica en entornos de producción en Ayesa y buenas prácticas de desarrollo.',
        btnProjects: 'Ver Proyectos',
        btnExperience: 'Experiencia Laboral',
      },
      experience: {
      ...
      projects: {
        ...
        urbiTitle: 'UrbiConnect',
        urbiDesc:
          'Plataforma de gestión de incidencias municipal desarrollada para el Ayuntamiento de Cantillana. Facilita la comunicación directa entre la ciudadanía y los servicios operativos para el reporte, seguimiento y resolución de incidencias en la vía pública.',
        bullet1:
          'Diseño de flujos de interfaz (UI/UX) y ejecución de pruebas de calidad (QA) y validación funcional.',
        bullet2:
          'Configuración e integración de infraestructura cloud con <strong class="text-light">Firebase Auth, Firestore y Storage</strong>.',
...
<head>
  <meta charset="utf-8">
  <title>Sergio Algarrada | Full Stack & Mobile Developer</title>
  <base href="/">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="icon" type="image/x-icon" href="favicon.ico">
</head>
...
<div class="d-flex flex-wrap gap-2">
            ...
            <span class="badge bg-dark text-info border border-secondary">Spring Boot</span>
            <span class="badge bg-dark text-info border border-secondary">Angular</span>
            <span class="badge bg-dark text-info border border-secondary">PostgreSQL</span>
            <span class="badge bg-dark text-info border border-secondary">MySQL</span>
            <span class="badge bg-dark text-info border border-secondary">Git</span>
          </div>
...
/* Rotación suave de la flecha al abrir el desplegable */
.bi-chevron-down {
...
/* Resalte al pasar el cursor sobre las opciones */
.dropdown-item.hover-accent:hover {
  background-color: rgba(56, 189, 248, 0.1);
  color: var(--accent-cyan) !important;
}

/* Fuerza la alineación al extremo derecho sin depender de Popper/Bootstrap JS */
...
<nav class="navbar navbar-expand-lg fixed-top border-bottom" style="background-color: rgba(11, 17, 32, 0.85); backdrop-filter: blur(12px); border-color: var(--border-card) !important;">
  <div class="container">
    ...
    <div class="dropdown position-relative">
     <button
    type="button"
    class="btn btn-cv-glow btn-sm px-3 py-1 d-flex align-items-center gap-2"
    (click)="toggleCvMenu($event)"
    [attr.aria-expanded]="isCvMenuOpen()">

    <i class="bi bi-file-earmark-arrow-down-fill"></i>
    <span>Resume / CV</span>
    <i class="bi bi-chevron-down small" [class.rotate-180]="isCvMenuOpen()"></i>
...
<ul
  class="dropdown-menu dropdown-menu-dark dropdown-menu-end shadow-lg py-2 mt-2 border"
  [class.show]="isCvMenuOpen()"
  style="background-color: var(--bg-card); border-color: var(--border-card) !important;"
>
  <li>
    <a
      class="dropdown-item d-flex align-items-center gap-2 py-2 text-light hover-accent"
      href="cv-sergio-algarrada-es.pdf"
      target="_blank"
      rel="noopener noreferrer"
      (click)="closeMenu()"
    >
      <span class="badge bg-secondary bg-opacity-50 text-uppercase">ES</span>
  ...
  <li>
    <a
      class="dropdown-item d-flex align-items-center gap-2 py-2 text-light hover-accent"
      href="cv-sergio-algarrada-en.pdf"
      target="_blank"
      rel="noopener noreferrer"
      (click)="closeMenu()"
    >
      <span class="badge bg-secondary bg-opacity-50 text-uppercase">EN</span>
...
<footer class="py-4 text-center border-top" style="border-color: var(--border-card) !important;">
  <div class="container">
    ...
    <!-- Subtítulo técnico -->
    <p class="small text-secondary mb-0">{{i18n.t().footer.builtWith }} </p>
  </div>
</footer>
</file>
...
<section id="experience" class="py-5">
  <div class="container">
    <div class="mb-5">
      <h2 class="display-6 fw-bold text-light">{{ i18n.t().experience.title }}</h2>
    </div>
      ...
      <div class="col-lg-10">
        <div class="tech-card p-4">
          <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3">
            <div>
              <h3 class="h4 fw-bold text-light mb-1">{{ i18n.t().experience.role }}</h3>
              <h4 class="h6 text-secondary mb-0">{{ i18n.t().experience.company }}</h4>
            </div>
            <span class="badge bg-secondary bg-opacity-25 text-light border border-secondary border-opacity-25 mt-2 mt-md-0 align-self-start align-self-md-center">
              {{ i18n.t().experience.period }}
            </span>
          </div>

          <ul class="text-light opacity-75 mb-4">
            <li class="mb-2" [innerHTML]="i18n.t().experience.bullet1"></li>
            <li class="mb-2" [innerHTML]="i18n.t().experience.bullet2"></li>
            <li class="mb-2" [innerHTML]="i18n.t().experience.bullet3"></li>
            <li [innerHTML]="i18n.t().experience.bullet4"></li>
          </ul>
...
<nav class="navbar navbar-expand-lg fixed-top border-bottom" style="background-color: rgba(11, 17, 32, 0.85); backdrop-filter: blur(12px); border-color: var(--border-card) !important;">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" [class.show]="isMenuOpen()" id="navbarNav">
      ...
      <ul class="navbar-nav mx-auto my-3 my-lg-0 gap-lg-4 text-center">
        <li class="nav-item">
          <a class="nav-link nav-link-custom" href="#about" (click)="closeMenu()">{{ i18n.t().nav.about }}</a>
        </li>
        <li class="nav-item">
          <a class="nav-link nav-link-custom" href="#experience" (click)="closeMenu()">{{ i18n.t().nav.experience }}</a>
        </li>
        <li class="nav-item">
          <a class="nav-link nav-link-custom" href="#projects" (click)="closeMenu()">{{ i18n.t().nav.projects }}</a>
        </li>
        <li class="nav-item">
          <a class="nav-link nav-link-custom" href="#skills" (click)="closeMenu()">{{ i18n.t().nav.skills }}</a>
        </li>
      </ul>
      ...
      <div class="d-flex flex-column flex-lg-row align-items-center justify-content-center gap-3 pb-3 pb-lg-0">
        <!-- Redes -->
        <div class="d-flex align-items-center gap-3">
          <a href="https://github.com/sergioam26" target="_blank" rel="noopener noreferrer" class="text-light fs-5 opacity-75 hover-opacity-100" title="GitHub">
            <i class="bi bi-github"></i>
          </a>
          <a href="https://linkedin.com/in/sergio-algarrada-miranda-a5b353293" target="_blank" rel="noopener noreferrer" class="text-light fs-5 opacity-75 hover-opacity-100" title="LinkedIn">
            <i class="bi bi-linkedin"></i>
          </a>
        </div>
        ...
        <button
          type="button"
          class="btn btn-outline-secondary btn-sm px-2 py-1 text-light d-flex align-items-center gap-1 border-opacity-50"
          (click)="i18n.toggleLanguage()"
          [title]="i18n.currentLang() === 'en' ? 'Cambiar a Español' : 'Switch to English'"
        >
          <i class="bi bi-translate text-info"></i>
          <span class="fw-bold">{{ i18n.currentLang() === 'en' ? 'ES' : 'EN' }}</span>
        </button>
        ...
        <div class="dropdown position-relative">
          ...
          >
            <li>
              <a class="dropdown-item d-flex align-items-center gap-2 py-2 text-light hover-accent" href="cv-sergio-algarrada-es.pdf" target="_blank" rel="noopener noreferrer" (click)="closeMenu()">
                <span class="badge bg-secondary bg-opacity-50 text-uppercase">ES</span>
                <span>{{ i18n.t().nav.resumeEs }}</span>
              </a>
            </li>
            <li>
              <a class="dropdown-item d-flex align-items-center gap-2 py-2 text-light hover-accent" href="cv-sergio-algarrada-en.pdf" target="_blank" rel="noopener noreferrer" (click)="closeMenu()">
                <span class="badge bg-secondary bg-opacity-50 text-uppercase">EN</span>
                <span>{{ i18n.t().nav.resumeEn }}</span>
              </a>
            </li>
          </ul>
        </div>
...
<section id="projects" class="py-5">
  <div class="container">
    <div class="mb-5">
      <h2 class="display-6 fw-bold text-light">{{ i18n.t().projects.title }}</h2>
    </div>
    ...
    <div class="row g-4">
      <div class="col-lg-8">
        <div class="tech-card p-4">
          <div class="d-flex justify-content-between align-items-center mb-3">
            <h3 class="h4 fw-bold text-light mb-0">{{ i18n.t().projects.urbiTitle }}</h3>
            <a href="https://github.com/sergioam26/UrbiConnect" target="_blank" rel="noopener noreferrer" class="text-light fs-5" title="GitHub Repository">
              <i class="bi bi-github"></i>
            </a>
          </div>
          ...
          <p class="text-light opacity-75 mb-3">
            {{ i18n.t().projects.urbiDesc }}
          </p>

          <ul class="text-light opacity-75 mb-4">
            <li class="mb-2">{{ i18n.t().projects.bullet1 }}</li>
            <li class="mb-2" [innerHTML]="i18n.t().projects.bullet2"></li>
            <li [innerHTML]="i18n.t().projects.bullet3"></li>
          </ul>
          ...
          <div class="d-flex flex-wrap gap-2">
            ...
            <span class="badge bg-dark text-info border border-secondary">Firebase</span>
            <span class="badge bg-dark text-info border border-secondary">Google Maps API</span>
            <span class="badge bg-dark text-info border border-secondary">{{ i18n.t().projects.badgeAi }}</span>
          </div>
        </div>
      </div>
    </div>
...
<section id="skills" class="py-5">
  <div class="container">
    <div class="mb-5">
      <h2 class="display-6 fw-bold text-light">{{ i18n.t().skills.title }}</h2>
    </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-6 col-lg-3">
        <div class="tech-card p-4 h-100">
          <div class="d-flex align-items-center gap-2 mb-3">
            <i class="bi bi-server fs-4" style="color: var(--accent-cyan)"></i>
            <h3 class="h5 fw-bold text-light mb-0">{{ i18n.t().skills.backend }}</h3>
          </div>
          <div class="d-flex flex-wrap gap-2">
            <span class="badge bg-dark border border-secondary text-light">Java</span>
            <span class="badge bg-dark border border-secondary text-light">Spring Boot</span>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="tech-card p-4 h-100">
          <div class="d-flex align-items-center gap-2 mb-3">
            <i class="bi bi-phone-flip fs-4" style="color: var(--accent-cyan)"></i>
            <h3 class="h5 fw-bold text-light mb-0">{{ i18n.t().skills.frontend }}</h3>
          </div>
          <div class="d-flex flex-wrap gap-2">
            <span class="badge bg-dark border border-secondary text-light">Angular</span>
            <span class="badge bg-dark border border-secondary text-light">Flutter</span>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="tech-card p-4 h-100">
          <div class="d-flex align-items-center gap-2 mb-3">
            <i class="bi bi-database fs-4" style="color: var(--accent-cyan);"></i>
            <h3 class="h5 fw-bold text-light mb-0">{{ i18n.t().skills.databases }}</h3>
          </div>
          <div class="d-flex flex-wrap gap-2">
            <span class="badge bg-dark border border-secondary text-light">MySQL</span>
            <span class="badge bg-dark border border-secondary text-light">PostgreSQL</span>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="tech-card p-4 h-100">
          <div class="d-flex align-items-center gap-2 mb-3">
            <i class="bi bi-gear-wide-connected fs-4" style="color: var(--accent-cyan);"></i>
            <h3 class="h5 fw-bold text-light mb-0">{{ i18n.t().skills.tools }}</h3>
          </div>
          <div class="d-flex flex-wrap gap-2">
            <span class="badge bg-dark border border-secondary text-light">Git &amp; GitHub</span>
            <span class="badge bg-dark border border-secondary text-light">GitFlow</span>
...
<section id="about" class="min-vh-100 d-flex align-items-center py-5">
  <div class="container">
    <div class="row align-items-center gy-5">
      <!-- Columna de texto y presentación -->
      <div class="col-lg-7">
        <span class="badge status-pill px-3 py-2 rounded-pill mb-3 fs-6 fw-normal">
          <i class="bi bi-circle-fill me-1" style="font-size: 0.6rem;"></i> {{ i18n.t().hero.status }}
        </span>
  ...
  <a href="mailto:sergioalgmir@gmail.com" class="btn btn-outline-info px-3 py-2 d-flex align-items-center gap-2">
    <i class="bi bi-envelope-fill"></i>
    <span>{{ i18n.t().hero.btnContact }}</span>
  </a>
</div>
      </div>
      ...
      <div class="col-lg-5 text-center">
        <div class="hero-photo-wrapper d-inline-block position-relative">
          <img
            src="sergio.png"
            alt="Sergio Algarrada Miranda"
            class="img-fluid rounded-circle hero-photo"
          />
        </div>
      </div>
    </div>
...
<section id="skills" class="py-5">
  <div class="container">
    ...
    <!-- 4 Tarjetas principales simétricas -->
    ...
    <!-- Barra compacta de Acreditaciones -->
    <div class="tech-card p-4">
      <div class="row align-items-center gy-3">
        <div class="col-lg-8">
          <div class="row g-3">
            ...
            <div class="col-sm-6">
              <div class="d-flex align-items-center gap-3">
                <i class="bi bi-patch-check-fill fs-2" style="color: var(--accent-cyan);"></i>
                <div>
                  <h4 class="h6 fw-bold text-light mb-0">{{ i18n.t().skills.certOpenWebinars }}</h4>
                  <p class="small text-secondary mb-0">{{ i18n.t().skills.certOpenWebinarsSub }}</p>
                </div>
              </div>
            </div>
            <!-- Cambridge B2 -->
            <div class="col-sm-6">
              <div class="d-flex align-items-center gap-3">
                <i class="bi bi-award-fill fs-2" style="color: var(--accent-green);"></i>
                <div>
                  <h4 class="h6 fw-bold text-light mb-0">{{ i18n.t().skills.certEnglish }}</h4>
                  <p class="small text-secondary mb-0">{{ i18n.t().skills.certEnglishSub }}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="col-lg-8">
        <div class="tech-card p-4">
          ...
          <p class="text-info small mb-3">
            <i class="bi bi-award-fill me-1"></i> {{ i18n.t().projects.awardDesc }}
          </p>
          ...
          <div class="d-flex flex-wrap gap-2">
            ...
            <span class="badge bg-dark text-info border border-secondary">Firebase</span>
            <span class="badge bg-dark text-info border border-secondary">Google Maps API</span>
            <span class="badge bg-dark border border-secondary text-light">{{ i18n.t().projects.badgeAi }}</span>
          </div>
        </div>
      </div>
    </div>
